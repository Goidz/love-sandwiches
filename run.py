...
def get_sales_data():
    ...
    which must be a string of 6 numbers seperated by commas. The loop will repeatedly 
...
def validate_data(values):
    """
    Inside thr try, converts all strings to integers.
...
"""
Functions to update worksheets! 
...
def calculate_surplus_data(sales_row):
    ...
    - Negative surplus indicates extrea made when stock ran out.
    """
...
def get_last_5_entries_sales():
    ...
    the last 5 entries for each sandwich and 
